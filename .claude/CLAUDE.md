...
| `app/q/[token]/page.tsx` · `_components/PublicQuoteView.tsx` | **Public** "Client Quote Profile" (no admin cookie, `force-dynamic`, noindex). Token → `PublicQuote`; work-first sell layout: proofs, suite, investment, contact CTA |
...
| `app/quotes/[id]/page.tsx` | Gated **"Profile Overview"** — per-quote admin detail (link controls, client-facing summary, admin-proxied proofs) |
