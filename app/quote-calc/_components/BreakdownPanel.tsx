...
function PackageLineBlock({
  ...
  const combinedDiscountPtg = r.discountPtg + r.vendorIncentivePtg;
  ...
  return (
    <div className={cn(showHeader && "rounded-lg border border-border bg-muted/20 p-3 mt-3")}>
      ...
      {/* ─── ADJUSTMENTS ─── */}
      {(reuseDisplaySavings > 0 || r.discountPtg > 0 || r.vendorIncentivePtg > 0) && (
      ...
      {combinedDiscountPtg > 0 && r.vendorIncentivePtg > 0 && (
