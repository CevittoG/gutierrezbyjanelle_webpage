...
export const dictionary = {
  en: {
    ...
    "cta.weddingPricing": "Wedding pricing",
    "cta.eventPricing": "Event pricing",
    ...
    "investment.wedding.body": "Each tier builds on the last. The ✦ marks how much a suite saves compared to individual pricing.",
    ...
    "investment.events.body": "The same craft, tailored for celebrations beyond the wedding day. The ✦ marks how much a collection saves compared to individual pricing.",
  ...
  es: {
    ...
    "cta.weddingPricing": "Precios de boda",
    "cta.eventPricing": "Precios de eventos",
    ...
    "investment.wedding.body": "Cada nivel se construye sobre el anterior. El ✦ marca cuánto ahorra una colección comparado con los precios individuales.",
    ...
    "investment.events.body": "La misma dedicación, adaptada para celebraciones más allá del día de la boda. El ✦ marca cuánto ahorra una colección comparado con los precios individuales.",
