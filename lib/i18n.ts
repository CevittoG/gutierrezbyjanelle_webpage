...
export const dictionary = {
  en: {
    ...
    "cta.weddingInvestment": "Wedding investment",
    "cta.eventInvestment": "Event investment",
    ...
    "investment.wedding.body": "Each tier builds on the last. The ✦ marks how much a suite saves compared to investing in each piece separately.",
    "investment.events.eyebrow": "Dinner Parties, Graduations, Baby Showers, Birthdays, and More",
    "investment.events.heading": "Event Collections",
    "investment.events.body": "The same craft, tailored for celebrations beyond the wedding day. The ✦ marks how much a collection saves compared to investing in each piece separately.",
  ...
  es: {
    ...
    "cta.weddingInvestment": "Inversión de boda",
    "cta.eventInvestment": "Inversión de eventos",
    ...
    "cta.readMyStory": "Lee mi historia",
    ...
    "investment.wedding.body": "Cada nivel se construye sobre el anterior. El ✦ marca cuánto ahorra una colección comparado con invertir en cada pieza por separado.",
    "investment.events.eyebrow": "Cenas, Graduaciones, Baby Showers, Cumpleaños y Más",
    "investment.events.heading": "Colecciones para Eventos",
    "investment.events.body": "La misma dedicación, adaptada para celebraciones más allá del día de la boda. El ✦ marca cuánto ahorra una colección comparado con invertir en cada pieza por separado.",
