  ...
  investments: [
    ...
    },
    {
      ...
      features: [
        ...
        b("Invite", "Invitación"),
        b("Envelope printing", "Impresión de sobres"),
        b("Band, Clip or pocket", "Cinta, Clip o bolsillo"),
        b("Ceremony cards", "Tarjetas de ceremonia"),
    ...
    },
    {
      ...
      features: [
        ...
        b("Drink charms", "Charms para bebidas"),
        b("Wine charm bundles", "Paquetes de charms para copas de vino"),
        b("Drink charm bundles", "Paquetes de charms para bebidas"),
        b("Suite pocket, clip, band", "Bolsillo, clip y cinta para la colección"),
        b("Standard wax seal adhesive", "Sello de cera estándar adhesivo"),
        b("Envelope liners", "Forros para sobres"),
